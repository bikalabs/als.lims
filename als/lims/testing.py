...
class ALSTestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        self.loadZCML(package=als.lims)

        # Required by Products.CMFPlone:plone-content
        z2.installProduct(app, 'Products.PythonScripts')
        z2.installProduct(app, 'als.lims')
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'als.lims:default')
        ...
        self.request.form['existing'] = "als.lims:test"
        lsd = LoadSetupData(portal, self.request)
        lsd()

        logout()

CUSTOM_TEST_FIXTURE = ALSTestLayer()

ALS_CUSTOM_TESTING = FunctionalTesting(
